...
builder.Services.AddScoped<ICatalogoDashboard, CatalogoDashboard>();
builder.Services.AddScoped<ICatalogoCredito, CatalogoCredito>();
builder.Services.AddScoped<ICatalogoTransacciones, CatalogoTransacciones>();
